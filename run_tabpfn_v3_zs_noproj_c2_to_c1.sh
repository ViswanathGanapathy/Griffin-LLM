#!/bin/bash
# TabPFN v3 ZS, NO projection, vanilla-4 Griffin backbone (commerce-2 pretrained),
# eval on commerce-1. Validates the no-proj win in the c2->c1 direction.
#
# Usage:
#   ./run_tabpfn_v3_zs_noproj_c2_to_c1.sh 2>&1 | tee logs/tabpfn-zs-noproj-c2-to-c1.log

export CUDA_VISIBLE_DEVICES=${CUDA_VISIBLE_DEVICES:-0}

PYTHONUNBUFFERED=1 python hmaintask_combine_llm.py \
    datasets/joint-v65 logs/tabpfn-zs-noproj-c2-to-c1 tabpfn-zs-noproj-c2-to-c1 \
    --head tabpfn \
    ...
    --savepath checkpoints/tabpfn-zs-noproj-c2-to-c1
